...
public class GUIDriver extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		btnR.setOnAction(e -> {
			try {
				Fraction f = new Fraction(Integer.valueOf(num3.getText()), Integer.valueOf(denom3.getText()));
		...
		btnA.setOnAction(e -> {
			try {
				...
				num3 = num1.add(num2);
				denom3 = denom1.add(denom2);
				// maybe in add method we do numerator and denominator separated and
				// num3.setText(String.valueOf(f.getNumerator())) and denominator;
				// ^ not likely
				// should prob pass in fraction f, compute and then return by .getnumerator and
				// .getdenominator
